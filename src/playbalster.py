...
class PlayblastUI(QtWidgets.QDialog):
    ...
    def export_image_sequence(self):
        ...
        self.convert_to_mp4(output_dir, frames_dir, name)

    def convert_to_mp4(self, output_dir, frames_dir, base_name):
        ffmpeg_path = self.ffmpeg_line_edit.text()
        ...
        try:
            ...
            self.upload_to_shotgrid(base_name, proxy=mp4_output_path)  # Call the method to upload to ShotGrid with short name and proxy path
